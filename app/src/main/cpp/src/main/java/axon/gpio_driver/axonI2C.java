//
// Change the package name to match with your own
//
package axon.gpio_driver;
...
public class axonI2C {
    ...
    /**
     * @param nodeName node path name
     * @param State    state of output 0,1,2 or 3
     * @return return file hander else return <0 on fail
     */
    ...
    /**
     * @param nodeName node path name
     * @param State    state of output 0,1 for LOW or HIGH
